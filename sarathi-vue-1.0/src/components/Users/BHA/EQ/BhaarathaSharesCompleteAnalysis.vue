<template>
  <div class="bhaaratha-shares-complete-analysis">
...
export default {
  ...
  methods: {
    getAnalysisDetails() {
      ...
      if(this.$store.getters["bhaarathaSharesCompleteAnalysis/GET_BHAARATHA_SHARES_SECTOR_MAP"].size === 0) {
        axios.get(services.bhaarathaSharesCompleteAnalysis).then(response => {
          if (response.status === 204) {
            ...
            this.$store.commit("bhaarathaSharesCompleteAnalysis/SET_BHAARATHA_SHARES_SECTOR_MAP", response.data.bhaarathaSharesSectorMap);
            this.$store.commit("bhaarathaSharesCompleteAnalysis/SET_BHAARATHA_SHARES_SECTOR_LONG_TERM_ONLY_MAP", response.data.bhaarathaSharesSectorLongTermOnlyMap);
            this.$store.commit("bhaarathaSharesCompleteAnalysis/SET_BHAARATHA_SHARES_CATEGORY_MAP", response.data.bhaarathaSharesCategoryMap);
            this.$store.commit("bhaarathaSharesCompleteAnalysis/SET_BHAARATHA_SHARES_CATEGORY_LONG_TERM_ONLY_MAP", response.data.bhaarathaSharesCategoryLongTermOnlyMap);
            this.$store.commit("bhaarathaSharesCompleteAnalysis/SET_BHAARATHA_SHARES_ONE_SECTOR_DETAILS_MAP", response.data.bhaarathaSharesOneSectorDetailsMap);
            this.$store.commit("bhaarathaSharesCompleteAnalysis/SET_BHAARATHA_SHARES_ONE_SECTOR_DETAILS_LONG_TERM_ONLY_MAP", response.data.bhaarathaSharesOneSectorDetailsLongTermOnlyMap);
            this.$store.commit("bhaarathaSharesCompleteAnalysis/SET_BHAARATHA_SHARES_ONE_CATEGORY_DETAILS_MAP", response.data.bhaarathaSharesOneCategoryDetailsMap);
            this.$store.commit("bhaarathaSharesCompleteAnalysis/SET_BHAARATHA_SHARES_ONE_CATEGORY_DETAILS_LONG_TERM_ONLY_MAP", response.data.bhaarathaSharesOneCategoryDetailsLongTermOnlyMap);
    ...
    getAnalysisData() {
      ...
      if (this.isSectorAnalysis && !this.isLongTermOnly) {
        for (let [key, val] of this.$store.getters["bhaarathaSharesCompleteAnalysis/GET_BHAARATHA_SHARES_SECTOR_MAP"]) {
          if (key !== "total") {
        ...
        for (let [key, val] of this.$store.getters["bhaarathaSharesCompleteAnalysis/GET_BHAARATHA_SHARES_SECTOR_LONG_TERM_ONLY_MAP"]) {
          if (key !== "total") {
            this.oneAnalysisDropdownList.push({ id: val.sectorName, value: val.sectorName});
            xAxisTitlesList.push(val.sectorName);
            if (!this.isValueInPercentage) {
        ...
        for (let [key, val] of this.$store.getters["bhaarathaSharesCompleteAnalysis/GET_BHAARATHA_SHARES_CATEGORY_MAP"]) {
          if (key !== "total") {
        ...
        for (let [key, val] of this.$store.getters["bhaarathaSharesCompleteAnalysis/GET_BHAARATHA_SHARES_CATEGORY_LONG_TERM_ONLY_MAP"]) {
          if (key !== "total") {
            this.oneAnalysisDropdownList.push({ id: val.categoryName, value: val.categoryName});
            xAxisTitlesList.push(val.categoryName);
            if (!this.isValueInPercentage) {
    ...
    onRefreshClick() {
      // Clear store
      this.$store.commit("bhaarathaSharesCompleteAnalysis/SET_BHAARATHA_SHARES_SECTOR_MAP", new Map());
      this.$store.commit("bhaarathaSharesCompleteAnalysis/SET_BHAARATHA_SHARES_SECTOR_LONG_TERM_ONLY_MAP", new Map());
      this.$store.commit("bhaarathaSharesCompleteAnalysis/SET_BHAARATHA_SHARES_CATEGORY_MAP", new Map());
      this.$store.commit("bhaarathaSharesCompleteAnalysis/SET_BHAARATHA_SHARES_CATEGORY_LONG_TERM_ONLY_MAP", new Map());
      this.$store.commit("bhaarathaSharesCompleteAnalysis/SET_BHAARATHA_SHARES_ONE_SECTOR_DETAILS_MAP", new Map());
      this.$store.commit("bhaarathaSharesCompleteAnalysis/SET_BHAARATHA_SHARES_ONE_SECTOR_DETAILS_LONG_TERM_ONLY_MAP", new Map());
      this.$store.commit("bhaarathaSharesCompleteAnalysis/SET_BHAARATHA_SHARES_ONE_CATEGORY_DETAILS_MAP", new Map());
      this.$store.commit("bhaarathaSharesCompleteAnalysis/SET_BHAARATHA_SHARES_ONE_CATEGORY_DETAILS_LONG_TERM_ONLY_MAP", new Map());
    ...
    onOneAnalysisDropdownSelect(selectedType) {
      ...
      this.$router.push("/users/BHA/EQ/one-analysis?type=" + type + "&name=" + selectedType.value + "&isLongTermOnly=" + isLongTermOnly + "&isValueInPercentage=" + isValueInPercentage + "&analysisService=complete-analysis");
    },
