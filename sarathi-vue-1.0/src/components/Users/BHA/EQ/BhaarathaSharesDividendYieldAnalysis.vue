<template>
  <div class="bhaaratha-shares-dividend-yield-analysis">
    <BhaarathaSharesSectorCategoryAnalysisHeader
    ...
    <BhaarathaSharesSectorCategoryAnalysisSettingsModal
      v-if="showSettings"
...
<script>
import BhaarathaSharesSectorCategoryAnalysisHeader from "@/components/Users/BHA/EQ/Analysis/BhaarathaSharesSectorCategoryAnalysisHeader.vue";
...
import BhaarathaSharesSectorCategoryAnalysisSettingsModal from "@/components/Users/BHA/EQ/Analysis/BhaarathaSharesSectorCategoryAnalysisSettingsModal.vue";
...
export default {
  ...
  methods: {
    getAnalysisDetails() {
      ...
      if(this.$store.getters["bhaarathaSharesDividendYieldAnalysis/GET_BHAARATHA_SHARES_SECTOR_MAP"].size === 0) {
        axios.get(services.bhaarathaSharesDividendYieldAnalysis).then(response => {
          if (response.status === 204) {
            ...
            this.$store.commit("bhaarathaSharesDividendYieldAnalysis/SET_BHAARATHA_SHARES_SECTOR_MAP", response.data.bhaarathaSharesSectorMap);
            this.$store.commit("bhaarathaSharesDividendYieldAnalysis/SET_BHAARATHA_SHARES_SECTOR_LONG_TERM_ONLY_MAP", response.data.bhaarathaSharesSectorLongTermOnlyMap);
            this.$store.commit("bhaarathaSharesDividendYieldAnalysis/SET_BHAARATHA_SHARES_CATEGORY_MAP", response.data.bhaarathaSharesCategoryMap);
            this.$store.commit("bhaarathaSharesDividendYieldAnalysis/SET_BHAARATHA_SHARES_CATEGORY_LONG_TERM_ONLY_MAP", response.data.bhaarathaSharesCategoryLongTermOnlyMap);
            this.$store.commit("bhaarathaSharesDividendYieldAnalysis/SET_BHAARATHA_SHARES_ONE_SECTOR_DETAILS_MAP", response.data.bhaarathaSharesOneSectorDetailsMap);
            this.$store.commit("bhaarathaSharesDividendYieldAnalysis/SET_BHAARATHA_SHARES_ONE_SECTOR_DETAILS_LONG_TERM_ONLY_MAP", response.data.bhaarathaSharesOneSectorDetailsLongTermOnlyMap);
            this.$store.commit("bhaarathaSharesDividendYieldAnalysis/SET_BHAARATHA_SHARES_ONE_CATEGORY_DETAILS_MAP", response.data.bhaarathaSharesOneCategoryDetailsMap);
            this.$store.commit("bhaarathaSharesDividendYieldAnalysis/SET_BHAARATHA_SHARES_ONE_CATEGORY_DETAILS_LONG_TERM_ONLY_MAP", response.data.bhaarathaSharesOneCategoryDetailsLongTermOnlyMap);
    ...
    getAnalysisData() {
      ...
      if (this.isSectorAnalysis && !this.isLongTermOnly) {
        for (let [key, val] of this.$store.getters["bhaarathaSharesDividendYieldAnalysis/GET_BHAARATHA_SHARES_SECTOR_MAP"]) {
          if (key !== "total") {
        ...
        for (let [key, val] of this.$store.getters["bhaarathaSharesDividendYieldAnalysis/GET_BHAARATHA_SHARES_SECTOR_LONG_TERM_ONLY_MAP"]) {
          if (key !== "total") {
            this.oneAnalysisDropdownList.push({ id: val.sectorName, value: val.sectorName});
            xAxisTitlesList.push(val.sectorName);
            if (!this.isValueInPercentage) {
        ...
        for (let [key, val] of this.$store.getters["bhaarathaSharesDividendYieldAnalysis/GET_BHAARATHA_SHARES_CATEGORY_MAP"]) {
          if (key !== "total") {
        ...
        for (let [key, val] of this.$store.getters["bhaarathaSharesDividendYieldAnalysis/GET_BHAARATHA_SHARES_CATEGORY_LONG_TERM_ONLY_MAP"]) {
          if (key !== "total") {
            this.oneAnalysisDropdownList.push({ id: val.categoryName, value: val.categoryName});
            xAxisTitlesList.push(val.categoryName);
            if (!this.isValueInPercentage) {
    ...
    onRefreshClick() {
      // Clear store
      this.$store.commit("bhaarathaSharesDividendYieldAnalysis/SET_BHAARATHA_SHARES_SECTOR_MAP", new Map());
      this.$store.commit("bhaarathaSharesDividendYieldAnalysis/SET_BHAARATHA_SHARES_SECTOR_LONG_TERM_ONLY_MAP", new Map());
      this.$store.commit("bhaarathaSharesDividendYieldAnalysis/SET_BHAARATHA_SHARES_CATEGORY_MAP", new Map());
      this.$store.commit("bhaarathaSharesDividendYieldAnalysis/SET_BHAARATHA_SHARES_CATEGORY_LONG_TERM_ONLY_MAP", new Map());
      this.$store.commit("bhaarathaSharesDividendYieldAnalysis/SET_BHAARATHA_SHARES_ONE_SECTOR_DETAILS_MAP", new Map());
      this.$store.commit("bhaarathaSharesDividendYieldAnalysis/SET_BHAARATHA_SHARES_ONE_SECTOR_DETAILS_LONG_TERM_ONLY_MAP", new Map());
      this.$store.commit("bhaarathaSharesDividendYieldAnalysis/SET_BHAARATHA_SHARES_ONE_CATEGORY_DETAILS_MAP", new Map());
      this.$store.commit("bhaarathaSharesDividendYieldAnalysis/SET_BHAARATHA_SHARES_ONE_CATEGORY_DETAILS_LONG_TERM_ONLY_MAP", new Map());
    ...
    onOneAnalysisDropdownSelect(selectedType) {
      ...
      this.$router.push("/users/BHA/EQ/one-analysis?type=" + type + "&name=" + selectedType.value + "&isLongTermOnly=" + isLongTermOnly + "&isValueInPercentage=" + isValueInPercentage + "&analysisService=dividend-yield-analysis");
    },
