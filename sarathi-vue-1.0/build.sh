...
declare -r CONFIG_DIRECTORY_LOCATION="F:/money-manager/Server/config/1.0/Vue"
declare -r SCSS_FILE_NAME="sarathi-vue-money-manager"
...
if ! (`cp ${CONFIG_DIRECTORY_LOCATION}/$environment/.env ${CURRENT_DIRECTORY}/.env`)
then
  echo "*********************"
  echo "******* ERROR *******"
  echo "*********************"
...
# Starting Sarathi Vue app
echo "Staring Sarathi Vue app"
echo
vue-cli-service serve --mode $environment
