...
@Component({
  selector: 'app-bhaaratha-shares-bought-sold-header',
  templateUrl: './bhaaratha-shares-bought-sold-header.component.html',
  styleUrls: ['./bhaaratha-shares-bought-sold-header.component.css']
})
export class BhaarathaSharesBoughtSoldHeaderComponent implements OnInit {
  ...
  onSharesBoughtClick() {
    this.router.navigate(["/users/BHA/EQ/bought-shares"]);
  }

  onSharesSoldClick() {
    this.router.navigate(["/users/BHA/EQ/sold-shares"]);
  }
