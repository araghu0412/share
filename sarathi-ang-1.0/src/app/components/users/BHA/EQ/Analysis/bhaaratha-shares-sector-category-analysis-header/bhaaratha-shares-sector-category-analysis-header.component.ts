...
@Component({
  selector: 'app-bhaaratha-shares-sector-category-analysis-header',
  templateUrl: './bhaaratha-shares-sector-category-analysis-header.component.html',
  styleUrls: ['./bhaaratha-shares-sector-category-analysis-header.component.css']
})
export class BhaarathaSharesSectorCategoryAnalysisHeaderComponent implements OnInit {
