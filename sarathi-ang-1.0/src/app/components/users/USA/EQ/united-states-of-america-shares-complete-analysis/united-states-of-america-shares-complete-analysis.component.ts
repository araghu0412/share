...
@Component({
  selector: 'app-united-states-of-america-shares-complete-analysis',
  templateUrl: './united-states-of-america-shares-complete-analysis.component.html',
  styleUrls: ['./united-states-of-america-shares-complete-analysis.component.css']
})
export class UnitedStatesOfAmericaSharesCompleteAnalysisComponent implements OnInit {
  ...
  getAnalysisDetails() {
    ...
    if(this.unitedStatesOfAmericaSharesCompleteAnalysisStoreService.getUnitedStatesOfAmericaSharesSectorMap().size === 0) {
      this.http.get(services.unitedStatesOfAmericaSharesCompleteAnalysis).subscribe((response: any) => {
        if (response === null) {
          this.noRecords = true;
          this.loading = false;
          ...
          this.unitedStatesOfAmericaSharesCompleteAnalysisStoreService.setUnitedStatesOfAmericaSharesSectorMap(response.unitedStatesOfAmericaSharesSectorMap);
          this.unitedStatesOfAmericaSharesCompleteAnalysisStoreService.setUnitedStatesOfAmericaSharesSectorLongTermOnlyMap(response.unitedStatesOfAmericaSharesSectorLongTermOnlyMap);
          this.unitedStatesOfAmericaSharesCompleteAnalysisStoreService.setUnitedStatesOfAmericaSharesCategoryMap(response.unitedStatesOfAmericaSharesCategoryMap);
          this.unitedStatesOfAmericaSharesCompleteAnalysisStoreService.setUnitedStatesOfAmericaSharesCategoryLongTermOnlyMap(response.unitedStatesOfAmericaSharesCategoryLongTermOnlyMap);
          this.unitedStatesOfAmericaSharesCompleteAnalysisStoreService.setUnitedStatesOfAmericaSharesOneSectorDetailsMap(response.unitedStatesOfAmericaSharesOneSectorDetailsMap);
          this.unitedStatesOfAmericaSharesCompleteAnalysisStoreService.setUnitedStatesOfAmericaSharesOneSectorDetailsLongTermOnlyMap(response.unitedStatesOfAmericaSharesOneSectorDetailsLongTermOnlyMap);
          this.unitedStatesOfAmericaSharesCompleteAnalysisStoreService.setUnitedStatesOfAmericaSharesOneCategoryDetailsMap(response.unitedStatesOfAmericaSharesOneCategoryDetailsMap);
          this.unitedStatesOfAmericaSharesCompleteAnalysisStoreService.setUnitedStatesOfAmericaSharesOneCategoryDetailsLongTermOnlyMap(response.unitedStatesOfAmericaSharesOneCategoryDetailsLongTermOnlyMap);
  ...
  getAnalysisData() {
    ...
    if (this.isSectorAnalysis && !this.isLongTermOnly) {
      for (let [key, val] of this.unitedStatesOfAmericaSharesCompleteAnalysisStoreService.getUnitedStatesOfAmericaSharesSectorMap()) {
        if (key !== "total") {
      ...
      for (let [key, val] of this.unitedStatesOfAmericaSharesCompleteAnalysisStoreService.getUnitedStatesOfAmericaSharesSectorLongTermOnlyMap()) {
        if (key !== "total") {
          this.oneAnalysisDropdownList.push({ id: val.sectorName, value: val.sectorName});
          xAxisTitlesList.push(val.sectorName);
          if (!this.isValueInPercentage) {
      ...
      for (let [key, val] of this.unitedStatesOfAmericaSharesCompleteAnalysisStoreService.getUnitedStatesOfAmericaSharesCategoryMap()) {
        if (key !== "total") {
      ...
      for (let [key, val] of this.unitedStatesOfAmericaSharesCompleteAnalysisStoreService.getUnitedStatesOfAmericaSharesCategoryLongTermOnlyMap()) {
        if (key !== "total") {
          this.oneAnalysisDropdownList.push({ id: val.categoryName, value: val.categoryName});
          xAxisTitlesList.push(val.categoryName);
          if (!this.isValueInPercentage) {
  ...
  onOneAnalysisDropdownSelect(selectedType: any) {
    ...
    this.router.navigate(["/users/USA/EQ/one-analysis"], { queryParams: { type: type,  name: selectedType.value, isLongTermOnly: isLongTermOnly, isValueInPercentage: isValueInPercentage, analysisService: "complete-analysis" } });
  }
